...
//go:generate swagger generate server --target ../../src --name GoRestAPI --spec ../pkg/swagger/swagger.yml --principal interface{}

func configureFlags(api *operations.GoRestAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GoRestAPIAPI) http.Handler {
